...
#define MyAppPath = ".\build\windows\x64\runner\Release\re_ucm.exe"
...
Source: ".\build\windows\x64\runner\Release\webview_all_windows_plugin.dll"; DestDir: "{app}"; Flags: ignoreversion
